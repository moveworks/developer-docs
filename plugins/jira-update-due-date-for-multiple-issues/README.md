...
```bash
curl --location 'https://<your-instance>/rest/api/3/search?jql=project%20%3D%20%22<project-key>%22%20AND%20issuetype%20%3D%20Bug%20AND%20status%20!%3D%20Done&startAt=0&maxResults=100' \
...
- <code>project-key or id or name</code> (String) - Replace this with the **exact project key** or **exact project name** or **exact project id**.
