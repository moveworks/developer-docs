---
description: "A plugin that queries Pagerduty\u2019s oncall schedule for support DRI,\
  \ and shares relevant information for the requester to followup with."
fidelity: VALIDATED
name: Lookup Oncall Support DRI
