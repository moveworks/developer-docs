---
description: A plugin that lets a HR Business Partner set up notifications over custom
  time periods before the deadline to ensure all required employees know when they
  need to complete training by.
fidelity: IDEA
