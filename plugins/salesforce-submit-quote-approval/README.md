...
This [purple chat](https://developer.moveworks.com/creator-studio/resources/plugin/?id=salesforce-submit-quote-approval) shows the experience we are going to build.
