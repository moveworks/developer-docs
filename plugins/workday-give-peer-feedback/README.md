...
The **“Give Peer Feedback”** plugin enables employees to provide peer feedback seamlessly through the **Moveworks AI Assistant**. It simplifies the Workday feedback process by allowing users to choose a colleague and share feedback in natural language—making it easier to recognize and collaborate with peers.
