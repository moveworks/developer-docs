...
fidelity: VALIDATED
description: A plugin that notifies users when their approval is needed on a role entitlement request, and allows the user to approve / reject the request.
