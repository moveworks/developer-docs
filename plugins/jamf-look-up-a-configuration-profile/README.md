...
description: "A plugin that allows IT administrators to search and view configuration\
  \ profiles in Jamf Pro via the Moveworks AI Assistant. This automation provides\
  \ quick visibility into profile details \u2014 including payload type, target scope,\
  \ and deployment status \u2014 helping admins validate compliance and troubleshoot\
  \ configuration coverage efficiently without navigating the Jamf console."
domain:
- IT
- Access Management
fidelity: IDEA
