...
### API #1: Get Computer and Mobile Devices

- This action is used to retrieve the list of computer and mobile devices.

```bash
curl --location 'https://<YOUR_INSTANCE>/JSSResource/{{filter_query}}' \
...
- $filter (string) – Filter by computer or mobile devices.

### API #2: Generate Enrollment Invitation

- This action is used to generate a device enrollment invitation.
