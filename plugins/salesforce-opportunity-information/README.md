...
```yaml
curl --location 'https://<YOUR_DOMAIN>//services/data/v62.0/query?q=SELECT  AccountId, Amount, StageName, CloseDate, Id FROM Opportunity WHERE Account.Name like '<account_name>' ORDER BY CloseDate DESC LIMIT 1' \
