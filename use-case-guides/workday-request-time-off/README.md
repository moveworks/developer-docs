...
1. If an employee selects a time off plan without Assuming an employees selects a time off plan that has adequate time off balance. An error message is thrown for an invalid time off 
