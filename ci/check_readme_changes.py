...
subprocess.run(f"export GH_TOKEN=$(cat \"/home/runner/work/developer-docs/developer-docs/.git/config\" | grep \"extraheader\" | cut -d ' ' -f 5 | cut -d ':' -f 2 | base64 -d | cut -d ':' -f 2); gh pr merge --auto --merge https://github.com/moveworks/developer-docs/pull/217")
